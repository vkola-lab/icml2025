    ...
    def train(self,
        ...
        for epoch in range(max_epochs):
            ...
            if self.loss_list[-1] < best_loss:
                ...
                torch.save(best_model, '/projectnb/vkolagrp/projects/active_feature_acquisition/codes/ckpts/imagenette_vit_small_explainer_bs128_lr1e4_conv_head_nsamples2_diff_eff_lambda_surr_with_lr_2e3_bs256_lrfactor_095.pt')
                if verbose:
